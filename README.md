...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
      A: React is most well known for being a virtual DOM. As a virtual DOM, it makes changes to the DOM based on changes made to itself from user interaction.

- [ ] What does it mean to _think_ in react?
      A: To think in its syntax and how state is passed down? (This question seems too broad and abstract.)

- [ ] Describe state.
      A: State is the data used in a component which can be passed down and used in other components for decorative purposes or for manipulation.

- [ ] Describe props.
      A: Props is a method or data from the state being passed down to another component. The methods are specifically made to manipulate the data of state in the parent component, so in order to
      manipulate that state from a child component, the method must be passed down and used by the child.
